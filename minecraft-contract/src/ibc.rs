...
use crate::{
    ...
    contract::try_set_item,
    msg::IbcExecuteMsg,
    ContractError,
};

pub const IBC_VERSION: &str = "minecraft-1";
...
pub fn do_ibc_packet_receive(
    ...
    match msg {
        IbcExecuteMsg::Transfer { wallet, item } => {
            let name = try_set_item(deps, wallet, item)?;
...
pub fn ibc_channel_close(
    ...
    // delete all state for pending items
